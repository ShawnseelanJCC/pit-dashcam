...
Three-region layout:
1. **Top bar** — team logo, race timer, lap counter, last lap, best lap, flag status buttons
2. **Main area** — left: live video feed with HUD overlay. Right: stream connect panel + race stats + lap log
3. **Bottom bar** — 4G/stream signal info, stint timer + driver tag, fuel estimator, pit notes textarea, event log
